...
use App\Models\Praktikum\{DaftarAnggotaKelompok, DaftarKelompok, JadwalPraktikum, PendaftarAcc, PendaftarAccd};
use Carbon\Carbon;
...
class PraktikumExport
{
    public static function exportDaftarHadir()
    {
        ...
        foreach($jadwal as $row){
            ...
            foreach(
                ...
                $table->addCell()->addText($tb->mhs->username, $fStyle, $pStyle2);
    ...
    public static function exportPenjadwalan()
    {
        ...
        foreach($kelompok as $row){
            ...
            foreach ($row->detail as $d) {
                $table->addRow(350);
                $table->addCell()->addText(++$no, $fStyle, $pStyle2);
                $table->addCell()->addText($d->mhs->username, $fStyle, $pStyle2);
    ...
    public static function exportDafdirPerMatkum()
    {
        //Open template with ${table}
        ...
        foreach($list_pendaftar as $row)
        {
            ...
            $table->addCell()->addText($row->mhs->username, $fStyle, $pStyle2);
            $table->addCell();
        }
    ...
    public static function exportDafdirPenguji()
    {
        $periode_id = Setting::find(1)->periode_aktif;
    ...
    public static function exportBAUjianPerMatkum()
    {
        //Open template with ${table}
        ...
        foreach($list_pendaftar as $row)
        {
            ...
            $table->addCell(1450)->addText($row->mhs->username, $fStyle, $pStyle2);
        ...
        $filename = "BA_Ujian - {$kel->matkum->nama_mp}(Penguji {$penguji}).docx";
    ...
    public static function exportBAPelaksanaanPerMatkum()
    {
        //Open template with ${table}
    ...
    public static function exportSertifikat()
    {
        $tmp = array(
        ...
        $template_document->setValue('nim', $angg->mhs->username);
