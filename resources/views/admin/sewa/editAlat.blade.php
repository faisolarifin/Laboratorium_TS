...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Penyewaan / Alat /</span> Edit</h5>
        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{route('adm.sewa.alat.u')}}" method="POST">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="kode_alat" value="{{$alat->id_alat}}">
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label" for="nm_alat">Nama Alat</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control w-50" id="nm_alat"
                                        placeholder="Nama Alat" name="nm_alat" value="{{$alat->nm_alat}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control w-50" id="biaya_umum"
                                        placeholder="Biaya Umum" name="biaya_umum" value="{{$alat->biaya_umum}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control w-50" id="biaya_khusus"
                                           placeholder="Biaya Khusus" name="biaya_khusus" value="{{$alat->biaya_khusus}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control w-50" id="jumlah"
                                           placeholder="Jumlah" name="jumlah" value="{{$alat->jumlah}}" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control w-50" id="kondisi"
                                           placeholder="Kondisi" name="kondisi" value="{{$alat->kondisi}}" />
                                </div>
                            </div>
