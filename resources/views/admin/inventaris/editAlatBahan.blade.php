...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-2"><span class="text-muted fw-light">Inventaris / Alat dan Bahan/</span> Edit</h5>
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Alat dan Bahan</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('adm.inv.bahan.u') }}" method="post">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="serial_num"
                                            placeholder="Serial Number" name="serial_num" value="{{ $row->serial_num }}" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="sub_loc" placeholder="Sub-Location"
                                            name="sub_loc" value="{{ $row->sub_loc }}" />
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="lot_num"
                                            placeholder="Lot Number" name="lot_num" value="{{ $row->lot_num }}" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="cas_num">CAS Number</label>
                                        <input type="number" class="form-control" id="cas_num"
                                            placeholder="CAS Number" name="cas_num" value="{{ $row->cas_num }}" />
                                    </div>
                                    <div class="mb-3">
