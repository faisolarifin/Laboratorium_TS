        ...
        <div class="row">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{route('adm.inv.permohon.s')}}" method="post">
                            @csrf
                            <div class="row mt-sm-2">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="spend_track" placeholder="Spend Tracking Code"
                                            name="spend_track" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="other_detail">Other Details</label>
                                        <input type="text" class="form-control" id="other_detail" placeholder="Other Details"
                                            name="other_detail" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="shipping" placeholder="Shipping & Handling"
                                            name="shipping" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="req" placeholder="Requistion #"
                                            name="req" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="confirm">Confirmation #</label>
                                        <input type="text" class="form-control" id="confirm" placeholder="Confirmation #"
                                            name="confirm" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="bought" placeholder="Bought From"
                                            name="bought" />
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="req_date"
                                            placeholder="Date Requested" name="req_date" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="appove_by"
                                            placeholder="Approved By" name="appove_by" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="order_by"
                                            placeholder="Ordered By" name="order_by" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="cancel_by"
                                            placeholder="Cancelled By" name="cancel_by" />
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="backorder_exp_date">Backorder - Expected Date</label>
                                    ...
                                    <div class="mb-3">
                                        <label class="form-label" for="receive_date">Date Received</label>
                                        <input type="date" class="form-control" id="receive_date"
                                            placeholder="Date Received" name="receive_date" />
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" for="receive_by">Received By</label>
                                        <input type="text" class="form-control" id="receive_by"
                                            placeholder="Received By" name="receive_by" />
                                    </div>
                                    <div class="mb-3">
