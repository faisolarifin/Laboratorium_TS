      ...
      <div class="row">
        ...
        <div class="col-xxl">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <form action="{{ route('plants.edit', $plant->id_plant) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="nm">Nama Plant</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nm" placeholder="Nama Plant" name="nm_plant" value="{{$plant->nm_plant}}" />
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="hg">Harga</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="hg" placeholder="Harga" name="price" value="{{$plant->price}}" />
                  </div>
                </div>
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="hg">Expired (Hari)</label>
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="hg" placeholder="Expired" name="expired" value="{{$plant->expired}}" />
                  </div>
                </div>
