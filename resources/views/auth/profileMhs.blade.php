        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="{{route('mhs.profile')}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                  <div class="col-sm-6">
                    <div class="mb-3">
                  ...
                  <div class="col-sm-6">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" id="alamat" rows="2" name="alamat">{{$mhs->alamat}}</textarea>
                    </div>
                    <div class="mb-3">
